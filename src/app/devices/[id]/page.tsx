  ...
  return (
    <main className="mx-auto w-full max-w-[1380px] space-y-6 py-6 md:py-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              ...
              {device.hostname && (
                <div className="space-y-1">
                  ...
                  <p className="text-sm">{device.hostname}</p>
                </div>
              )}
              {device.vendor && (
                <div className="space-y-1">
              ...
              {device.role && (
                <div className="space-y-1">
                  ...
                  <p className="text-sm">{device.role}</p>
                </div>
              )}
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {/* Services */}
        <Card className="min-w-0 bg-card/85 lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Active services discovered on this device
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            {!baseline ? (
              <div className="flex flex-col items-center gap-2 py-8 text-center">
                ...
                <p className="text-xs text-muted-foreground/70">
                  Run an agent cycle to collect latency measurements.
                </p>
              </div>
            ) : (
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="rounded-md border bg-background/50 p-3 text-center">
                    <p className="text-lg font-semibold tabular-nums">
                      {baseline.avgLatencyMs.toFixed(1)}
                    </p>
                  ...
                  <div className="rounded-md border bg-background/50 p-3 text-center">
                    <p className="text-lg font-semibold tabular-nums">
                      {baseline.minLatencyMs.toFixed(1)}
                    </p>
                    <p className="text-[10px] uppercase tracking-wide text-muted-foreground">
                      Min (ms)
                    </p>
                  ...
                  <div className="rounded-md border bg-background/50 p-3 text-center">
                    <p className="text-lg font-semibold tabular-nums">
                      {baseline.maxLatencyMs.toFixed(1)}
                    </p>
                    <p className="text-[10px] uppercase tracking-wide text-muted-foreground">
                      Max (ms)
                    </p>
      ...
      <Card className="min-w-0 bg-card/85">
        <CardHeader>
          ...
          <CardDescription>
            Knowledge graph edges involving this device
          </CardDescription>
        </CardHeader>
        <CardContent>
          {relatedEdges.length === 0 ? (
