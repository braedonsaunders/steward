...
export async function buildOnboardingSystemPrompt(device: Device): Promise<string> {
  ...
  return [
    ...
    "1a) When the user asks to probe, identify, or verify a management surface, do that first. Defer workload-purpose questions until after you have concrete evidence unless the missing context changes what you can safely probe.",
