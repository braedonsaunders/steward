...
export async function generateAndStoreDeviceWidget(
  ...
  const result = await generateText({
    ...
    system: [
      ...
      "Make the widget responsive and production-quality.",
      ...
      "- When the Steward host is macOS, WinRM requests must use HTTPS plus authentication: 'basic'. On Linux, prefer brokerRequest over shell-wrapped pwsh commands.",
      "",
      "Capabilities:",
